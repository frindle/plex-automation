...
LITERALS = [[None, "-codec_rank(c['title'])"], [None, '_dupe_candidate_sort_key'], [None, "-codec_rank(c['title']), -c['score'], -c['progress'], c['order']"], [None, "-codec_rank(c['title'])"], [None, '_sonarr_dupe_candidate_sort_key'], [None, "(-len(c['episodes']), -codec_rank(c['title']), -c['score'], -c['progress'], c['order'])"]]
