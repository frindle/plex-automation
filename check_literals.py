...
LITERALS = [[None, "SONARR_UPG_PRIORITY_LABEL = os.environ.get('SONARR_UPGRADE_PRIORITY_LABEL', 'sonarr-upgrade-recent')"], [None, 'airDateUtc'], [None, 'int(str(air_date)[:4])'], [None, '_is_recent_year(air_year)'], [None, 'ensure_label_exists_named(SONARR_UPG_PRIORITY_LABEL)'], [None, 'set_torrent_label(torrent_hash, SONARR_UPG_PRIORITY_LABEL)'], [None, "'method': 'core.queue_top', 'params': [priority_hashes]"]]
