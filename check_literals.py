...
LITERALS = [[None, 'def _save_upgrade_state(state):'], [None, "open(UPGRADE_STATE_PATH, 'w')"], [None, '_json.dump(state, f)'], [None, 'except Exception as e:'], [None, "log.warning(f'[upgrade-batches] failed to persist state: {e}')"]]
