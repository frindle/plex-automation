...
LITERALS = [[None, '_select_priority_hashes(torrents, priority_labels)'], [None, 'priority_hashes = _select_priority_hashes(torrents, priority_labels)'], [None, "'params': [priority_hashes]"]]
