...
LITERALS = [[None, "UPGRADE_STATE_PATH = os.environ.get('UPGRADE_STATE_PATH', '/data/upgrade_batch_state.json')"], [None, 'def _load_upgrade_state():'], [None, 'with open(UPGRADE_STATE_PATH) as f:'], [None, 'return _json.load(f)'], [None, 'except (FileNotFoundError, ValueError):']]
