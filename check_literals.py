...
LITERALS = [[None, 'weekly_quota_state(state, now)'], [None, "WEEKLY_UPGRADE_QUOTA - quota_entry['count'] <= 0"], [None, "'next_service'"], [None, "state.get('next_service') or 'radarr'"], [None, 'record_upgrades_found(state, count)'], [None, 'time.sleep(3600)  # check every hour']]
