...
LITERALS = [[None, 'upgrade_batch_due'], [None, 'UPGRADE_BATCH_INTERVAL_DAYS'], [None, '/run-monthly-upgrade'], ['test_upgrade_batches.py', 'sort_ids_by_year_desc'], ['test_upgrade_batches.py', 'advance_upgrade_cursor'], ['test_upgrade_batches.py', 'test_client()']]
