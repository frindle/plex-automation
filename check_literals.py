...
LITERALS = [[None, "for service in ('radarr', 'sonarr'):"], [None, 'UPGRADE_BATCH_INTERVAL_DAYS'], [None, "'last_run'"], [None, 'monthly_upgrade_cycle(service)'], [None, 'time.sleep(3600)  # check every hour']]
