...
LITERALS = [[None, "WEEKLY_UPGRADE_QUOTA = int(os.environ.get('WEEKLY_UPGRADE_QUOTA', '10'))"], [None, 'def weekly_quota_state(state, now=None):'], [None, 'def record_upgrades_found(state, n):'], [None, "'week_start'"], [None, '_save_upgrade_state(state)']]
